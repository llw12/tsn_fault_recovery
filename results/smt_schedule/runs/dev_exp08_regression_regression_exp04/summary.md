...
Run input was generated under `/home/opp_env/tsn_fault_recovery/experiments/exp04_smt_schedule/raw/dev_exp08_regression_regression_exp04`. Raw OMNeT++ vectors are intentionally excluded from Git and can be regenerated with the exp04 runner; committed CSV/Markdown/PNG files preserve the analyzed evidence.
