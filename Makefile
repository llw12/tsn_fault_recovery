#
# OMNeT++/OMNEST Makefile for tsn_fault_recovery
#
# This file was generated with the command:
#  opp_makemake -f --deep -O out -KINET_4_7_0_PROJ=../inet-4.7.0 -DINET_IMPORT -I. -I$$\(INET_4_7_0_PROJ\)/src -L$$\(INET_4_7_0_PROJ\)/src -lINET$$\(D\)
#

# Name of target to be created (-o option)
TARGET_DIR = .
TARGET_NAME = tsn_fault_recovery$(D)
